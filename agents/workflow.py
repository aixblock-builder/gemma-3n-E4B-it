...
class AgentWorkflow:
    def __init__(self, model_name_or_path="google/gemma-3n-e4b-it", pipe=None, tokenizer=None):
        llm = LLM(model_name_or_path=model_name_or_path, pipe=pipe, tokenizer=tokenizer)
